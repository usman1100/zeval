defmodule ZevalWeb.DashboardLive.ApiKeyLive do
  ...
  def mount(_params, session, socket) do
    {:ok, assign(socket, current_user: session["current_user"], active: "api-keys")}
  end
  ...
  def render(assigns) do
    ...
    <head>
      ...
      <title>Zeval Engine &mdash; API Keys</title>
    ...
    <body class="bg-gray-950 text-gray-100 antialiased">
      <div class="flex min-h-screen bg-gray-950">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
          <h2 class="text-2xl font-bold text-white mb-4">API Keys</h2>
